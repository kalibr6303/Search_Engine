 ...
 *  __ForkJoinPool__ Framework служит для эффективного распаралеливания выполнения задач, используя рекурсивные алгоритмы. Тенология используется в классе FindLink для построения логики обхода сайта и поиска всех внутренних ссылок;
